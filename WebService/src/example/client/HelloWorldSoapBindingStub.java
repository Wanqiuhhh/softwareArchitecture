...
public class HelloWorldSoapBindingStub extends org.apache.axis.client.Stub implements example.client.HelloWorld_PortType {
    ...
    public double sayHelloWorldFrom(double income) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
