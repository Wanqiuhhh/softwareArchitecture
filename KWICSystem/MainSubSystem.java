...
public class MainSubSystem {
    ...
    public static String process(String fileName) {
        MainSubSystem mainSubSystem = new MainSubSystem();
        mainSubSystem.input(fileName);
        mainSubSystem.shift();
        mainSubSystem.alphabetizer();
        //Iterator<String> it = mainSubSystem.kwicList.iterator();
        //return "Processed text (Main-Sub):\n" + mainSubSystem.kwicList;
        String output = mainSubSystem.output();
        return output;
    }
